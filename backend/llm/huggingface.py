"""
HuggingFace Serverless Inference API LLM 구현체.
환경변수 HF_TOKEN과 HF_MODEL로 제어.
"""
import os
import asyncio
import random
...
김지윤의 대사에 이민준으로서 자연스럽게 짧게 응답하세요. 2~3문장 이내로.""",
}
...
class HuggingFaceLLM:
    ...
    async def chat(
        ...
        try:
            reply = await asyncio.to_thread(self._call_api, messages)
